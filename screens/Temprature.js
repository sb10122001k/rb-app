...
const TempratureScreen = () => {
  const { temperatureData } = useContext(DataContext);
  ...
  return (
    <View style={{
      ...
      <CustomHeader/>
      <View>
        <Text style={{fontSize:20,fontWeight:'bold'}} >Temprature</Text>
      </View>
...
export default TempratureScreen;
